        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Izzy Immigration is a premier global mobility advisory firm helping high-net-worth individuals, entrepreneurs, and families secure second citizenship, permanent residency, and high-yield real estate worldwide.
            </p>
