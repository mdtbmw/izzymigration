...
const CATEGORIES = [
  {
    ...
    img: "/assets/imgs/portfolio/citizenship-programs.jpg",
    href: "/citizenship",
    tag: "Direct Passport",
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=800&q=85",
    href: "/residency",
    tag: "Permanent Residence",
  },
  {
    title: "Golden Visas",
    desc: "European Schengen settlement and residence permit investment corridors for families.",
    img: "/assets/imgs/portfolio/golden-visa-card.jpg",
    href: "/residency",
    tag: "European Golden Visa",
  },
  {
    title: "Citizenship by Descent & Ancestry",
    desc: "Citizenship by descent (Jus Sanguinis) securing full EU and global passport rights across generations.",
    img: "/assets/imgs/portfolio/ancestry-descent.jpg",
    href: "/ancestry",
    tag: "Ancestry & Descent",
  },
  {
    title: "Global Real Estate",
    desc: "Prime multi-building international developments paired with residency and citizenship benefits.",
    img: "/assets/imgs/portfolio/real-estate-skyline.jpg",
    href: "/real-estate",
    tag: "Prime Assets",
  },
];
