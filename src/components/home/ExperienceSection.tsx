          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-sm md:text-base text-body leading-relaxed">
                Izzy Migration Mentors has set the benchmark for discrete, compliant, and statutory global citizenship advisory. We cut through bureaucratic hurdles so your family can secure sovereign mobility with complete peace of mind.
              </p>
            </div>
