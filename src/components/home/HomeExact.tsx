                                ...
                                <div className="row align-items-center">
                                    <div className="col-xl-9 col-lg-10">
                                        <div className="banner-home__content p-relative">
                                            <span className="hero-eyebrow"><i className="fa-solid fa-crown"></i> ESTABLISHED SOVEREIGN ADVISORY · SINCE 2024</span>
                                            <h1 className="hero-title">Your Gateway To Global Mobility.</h1>
                                            <p className="hero-description">Residency and Citizenship by Investment for Global Mobility, Guided by Integrity, Strict Statutory Compliance, and Years of Advisory Experience.</p>
                                            ...
                                            <div className="hero-trust-bar">
                                                <div className="hero-stat-item">
                                                    ...
                                                    <div className="hero-stat-text">
                                                        <span className="hero-stat-val">3+ Years</span>
                            ...
                            <div className="accordion-item" style={{"border":"1px solid rgba(5,5,72,0.08)","borderRadius":"14px","marginBottom":"14px","overflow":"hidden","background":"#ffffff","boxShadow":"0 4px 14px rgba(5,5,72,0.03)"}}>
                                <h3 className="accordion-header" id="faq-heading-5">
                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-collapse-5" aria-expanded="false" aria-controls="faq-collapse-5" style={{"fontWeight":"700","color":"#050548","fontSize":"16px","padding":"20px 24px"}}>
                                        How does Izzy Migration Mentors protect client confidentiality and guarantee compliance?
                                    </button>
                                </h3>
                                <div id="faq-collapse-5" className="accordion-collapse collapse" aria-labelledby="faq-heading-5" data-bs-parent="#landingFaqAccordion">
                                    <div className="accordion-body" style={{"color":"#5a5a78","fontSize":"14.5px","lineHeight":"1.7","padding":"0 24px 22px"}}>
                                        Izzy Migration Mentors operates under strict statutory non-disclosure protocols and international AML/KYC standards. Before submitting any documents to government immigration units, our senior compliance team conducts a rigorous pre-vetting audit of your source of funds and background to ensure a 100% clean, seamless application trajectory.
                                    </div>
                                </div>
                            </div>
                        </div>
