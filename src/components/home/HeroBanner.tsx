...
const slides = [
  {
    ...
    stats: [
      { icon: Award, val: "30+ Years", lbl: "Advisory Experience" },
          ...
          <div className="lg:col-span-5 relative hidden lg:flex items-center justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="absolute -bottom-4 -left-4 bg-navy-950/95 backdrop-blur-md text-white rounded-2xl p-4 shadow-2xl z-20 border border-gold-500/40 flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white leading-tight">Licensed Legal Firm</h4>
                  <p className="text-[11px] text-gold-400 font-medium">30+ Years Global Heritage</p>
                </div>
              </div>
            </div>
          </div>
