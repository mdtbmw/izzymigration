...
import { advisoryYearsDisplay } from "@/data/siteConfig";

const SLIDES = [
  {
    eyebrow: "A Whole New World 🌍!",
    title: "Your Gateway To Global Mobility.",
    text: "Residency and Citizenship by Investment for Global Mobility, Guided by Integrity, Strict Statutory Compliance, and Institutional Excellence.",
    ...
    stats: [
      { icon: Award, value: advisoryYearsDisplay, label: "Advisory Experience" },
