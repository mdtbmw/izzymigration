            ...
            <div className="lg:col-span-5 w-full min-w-0">
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-surface-200 shadow-xl bg-navy-950">
                <img
                  ...
                  alt="Izzy Immigration Senior Advisory Desk"
              ...
              <div className="pt-2 flex flex-wrap gap-3">
                ...
                <a
                  href={createWhatsAppLink({
                    type: "consultation",
                    message: "Hello Izzy Immigration, I would like to schedule a private advisory consultation with Senior Counsel.",
                  })}
                  target="_blank"
