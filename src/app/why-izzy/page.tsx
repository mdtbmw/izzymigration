...
export default function WhyChooseUsPage() {
  return (
    <main className="w-full min-w-0 max-w-full overflow-hidden">
      <PageHero
        title="Why Choose Izzy Migration Mentors"
        subtitle="We are not a form-filling agency. Izzy Migration Mentors is a partner-led sovereign mobility advisory — delivering institutional precision, transparent counsel, and life-changing global freedom."
