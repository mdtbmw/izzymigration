...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Izzy Migration Mentors maintains dedicated on-the-ground archival research units across Italian provincial archives, Polish voivodeship registries, and the Irish Foreign Births Register, ensuring end-to-end dossier integrity.",
    ],
  },
  {
