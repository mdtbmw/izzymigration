...
export const generalFaqs: GeneralFAQ[] = [
  ...
  },
  {
    ...
    answer:
      "No. All the sovereign CBI and Golden Visa jurisdictions represented by Izzy Migration Mentors (including St. Kitts, Antigua, Dominica, Grenada, Saint Lucia, Malta, Vanuatu, Portugal, Greece, and Spain) legally permit dual and multiple citizenship. Your existing citizenship remains 100% confidential and intact.",
  },
  {
    category: "Residency",
  ...
  {
    category: "General",
    question: "How does Izzy Migration Mentors protect client confidentiality and funds?",
    answer:
      "Izzy Migration Mentors adheres to the strictest international legal confidentiality and GDPR standards. Client investment funds are deposited directly into designated government escrow accounts or regulated tier-1 institutional escrow banks. Funds are only disbursed upon statutory government approval milestones.",
  },
];
