(function ($) {
  ...
  ========================================*/
    ...
    var bannerHomeSlider = new Swiper(".banner-home-slider", {
        slidesPerView: 1,
        spaceBetween: 0,
        loop: true,
        speed: 1200,
        ...
        pagination: {
            el: ".banner-home-slider .swiper-pagination",
            clickable: true,
        },
        navigation: {
            nextEl: ".banner-home-slider .swiper-button-next",
            prevEl: ".banner-home-slider .swiper-button-prev",
        },
        a11y: {
    ...
    $('.take-appointment-3__form-input-select select, .take-appointment__form-input-select select, .doctor-details__form-input-select select, .appointment-2__form-input-select select, .pricing-appointment__form-select select, .ticket-booking-wrapper__from-item-select select ').niceSelect();
